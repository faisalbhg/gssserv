...
class SubmitCutomerServiceJob extends Component
{
    ...
    public function createJob(){
        ...
        $customerjobData = [
            ...
            'customer_name'=>$this->mobile = $customers->customerInfoMaster['TenantName'],
            'customer_email'=>$this->email = $customers->customerInfoMaster['Email'],
            'customer_mobile'=>$this->name = $customers->customerInfoMaster['Mobile'],
