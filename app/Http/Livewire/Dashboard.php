...
class Dashboard extends Component
{
    ...
    public $newcustomeoperation=false;
    public $showDashboard = true;
    public $newVehicleSearch=true;
    ...
    public $mobile, $name, $email, $customer_type=23, $customerTypeList, $customer_id_image;

    //Customer Vehicle
    public $showVehicleForm=true;
    public $numberPlateAddForm = true;
    public $otherVehicleDetailsForm=false;
    public $plate_state, $plate_code, $plate_number, $plate_number_final, $vehicle_image, $vehicleTypesList,$listVehiclesMake, $vehicle_type, $make, $vehiclesModelList, $model, $chassis_number,$vehicle_km,$plate_number_image,$chaisis_image;
    ...
    public $pendingCustomersCart=[],$showSearchModelView=false,$servicesGroupList,$stateList;
    ...
    public function newVehicleOpen(){
        $this->newVehicleSearch=false;
        $this->newcustomeoperation=true;
        $this->showSearchModelView=true;
    ...
    public function selectPendingVehicle($customerCart){
        
        $customers = json_decode($customerCart);
        //dd($customers);
        ...
        $this->sCtmrVhlcustomer_vehicle_id = $customers->vehicle_id;
        $this->sCtmrVhlvehicle_image =  $customers->vehicle_info->vehicle_image;
        $this->sCtmrVhlvehicleName =  $customers->vehicle_info->make;
        $this->sCtmrVhlmake_model =  $customers->vehicle_info->model;
        $this->sCtmrVhlplate_number =  $customers->vehicle_info->plate_number_final;
        $this->sCtmrVhlchassis_number =  $customers->vehicle_info->chassis_number;
        $this->sCtmrVhlvehicle_km =  $customers->vehicle_info->vehicle_km;
        $this->sCtmrVhlname =  $customers->customer_info->name;
        $this->sCtmrVhlcustomerType =  $customers->customer_info->customertype->customer_type;
        $this->sCtmrVhlemail =  $customers->customer_info->email;
        $this->sCtmrVhlmobile =  $customers->customer_info->mobile;

        $this->selected_vehicle_id = $customers->vehicle_id;
        $this->customer_id = $customers->customer_id;
        $this->customer_type = $customers->customer_info->customer_type;
        $this->mobile = $customers->customer_info->mobile;
        $this->name = $customers->customer_info->name;
        $this->email = $customers->customer_info->email;
