...
<head>
    ...
    <style>
        ...
        .logotype{color:#fff;width:200px;height:75px;  line-height: 75px; text-align: center; font-size:12px;}
        .column-title{background:#eee;text-transform:uppercase;padding:15px 5px 15px 15px;font-size:12px}
        .column-detail{border-top:1px solid #eee;border-bottom:1px solid #eee;}
        .column-header{background:#eee;text-transform:uppercase;padding:3px;font-size:12px;border-right:1px solid #000;}
        .tdrow{background:#fff; text-align: center;border-right:1px solid #000;}
...
<body onload="window.print()"> 
    <div class="container">
            ...
            <tr>
                    ...
                    <table>
                        <tr>
                            <td style="vertical-align: text-top;">
                                <div style="background: #ffb60061;width: 50px;height: 50px;margin-right: 10px;background-position: center;background-size: 42px;"><img src="{{ asset('img/Sample_User_Icon.png')}}" width="50" height="50"></div>
                            </td>
                            <td>
                ...
                <td>
                    <table>
                        <tr>
                            <td style="vertical-align: text-top;">
                                <div style="background: #ffb60061;width: 50px;height: 50px;margin-right: 10px;background-position: center;background-size: 42px;"><img src="{{ asset('img/invoicecar.png')}}" width="50" height="50"></div>
                            </td>
                            <td>
        ...
        <table width="100%" style="border-top:0px solid #eee;border-bottom:1px solid #eee;padding:0 0 8px 0; margin:5px 5px;">
            <tr>
                <td>Payment Methode: <strong>{{config('global.payment.type')[$jobInvoiceDetails->payment_type]}}</strong></td>
            </tr>
        </table>
        <table width="100%" style="border-collapse: collapse;border:1px solid #000;">
            ...
            <tr>
                ...
                <td class="tdrow" colspan="2" style="float:right; text-align: right; padding-right: 5px; font-size: 14px; font-weight:bold;">
                    <strong>{{custom_round($jobInvoiceDetails->total_price)}}</strong><br>
                </td>
            </tr>
            <tr style="border-top:1px solid #000; ">
                ...
                <td class=""  class="" colspan="6" align="left">
                    {{ $jobInvoiceDetails->cashierDetails['name'] }}
                </td>
            </tr>
            <tr style="border-bottom:1px solid #000;">
                <td class=""  class="" colspan="2" align="left">
                ...
                <td class=""  class="" colspan="6" align="left">
                    {{ \Carbon\Carbon::parse($jobInvoiceDetails->payment_updated_at)->format('dS M Y H:i A') }}
                </td>
            </tr>
        </table>
        <table width="100%">
