                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}.{{$chSubTypeDtlkey}}" value="G" id="check{{$chTypeKey}}{{$chSubTypeKey}}{{$chSubTypeDtlkey}}G">
                                            <label class="custom-control-label" for="check{{$chTypeKey}}{{$chSubTypeKey}}{{$chSubTypeDtlkey}}G">Good</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}.{{$chSubTypeDtlkey}}" value="NG" id="check{{$chTypeKey}}{{$chSubTypeKey}}{{$chSubTypeDtlkey}}NG">
                                            <label class="custom-control-label" for="check{{$chTypeKey}}{{$chSubTypeKey}}{{$chSubTypeDtlkey}}NG">Not Good</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}.{{$chSubTypeDtlkey}}" value="NA" id="check{{$chTypeKey}}{{$chSubTypeKey}}{{$chSubTypeDtlkey}}NA">
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body p-2">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}" value="G" id="check{{$chTypeKey}}{{$chSubTypeKey}}G">
                                            <label class="custom-control-label" for="check{{$chTypeKey}}{{$chSubTypeKey}}G">Good</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}" value="NG" id="check{{$chTypeKey}}{{$chSubTypeKey}}NG">
                                            <label class="custom-control-label" for="check{{$chTypeKey}}{{$chSubTypeKey}}NG">Not Good</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="radio" wire:model="checklists.glazing.{{$chTypeKey}}.{{$chSubTypeKey}}" value="NA" id="check{{$chTypeKey}}{{$chSubTypeKey}}NA">
