                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <button class="btn btn-icon btn-3 btn-info" type="button" wire:click="clickQlOperation('start','service','{{$services->id}}')">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <button class="btn btn-icon btn-3 btn-primary" type="button" wire:click="clickQlOperation('stop','service','{{$services->id}}')">
