<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                            ...
                            <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g id="Rounded-Icons" transform="translate(-1716.000000, -439.000000)" fill="#FFFFFF"
                                    ...
                                    <g id="Icons-with-opacity" transform="translate(1716.000000, 291.000000)">
                                        <g id="Dashboard-" transform="translate(0.000000, 148.000000)">
            ...
            <li class="nav-item pb-2 {{!in_array((auth()->user('user')->user_type),config('global.user_type_access')['administrator']) ? 'd-none': ''}}">
                <a class="nav-link {{ in_array(request()->route()->getName(),['manual-discounts']) ? 'active' : ' ' }}"
                    href="{{ route('manual-discounts') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="ni ni-basket ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['manual-discounts']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
