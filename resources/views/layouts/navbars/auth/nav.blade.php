                    ...
                    <li class="nav-item px-0 d-flex align-items-center"  >
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <li><a class="dropdown-item" href="{{ route('kabi-llc') }}"  wire:click="cartaxiClick('unique_id1')" wire:navigate>KABI L.L.C
                                ...
                                <li><a class="dropdown-item" href="{{ route('kabi-llc') }}">Emirates Catering</a></li> -->
                            </ul>
                        </div>
                    </li>
