        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 mb-xl-2 my-2">
                <a href="javascript:;" class="">
                        ...
                        <div class="card-body pt-5">
                            <h4 class="text-white mb-0 pb-0">
                                @if($selectedVehicleInfo['customerInfoMaster']['TenantName'])
                                    <p class="text-lg text-bold mb-0">{{$selectedVehicleInfo['customerInfoMaster']['TenantName']}}</p>
                                    <p class="text-lg text-bold mb-0">{{$selectedVehicleInfo['customerInfoMaster']['Mobile']}}</p>
                                    <p>{{$selectedVehicleInfo['customerInfoMaster']['Email']}}</p>
                                    <p class="text-sm font-weight-bold mb-2 text-capitalize text-warning"> 
                            ...
                            <p class="mb-4"><b>Vehicle:</b> {{$selectedVehicleInfo['make']}}, {{$selectedVehicleInfo['model']}}
                            <br>
                            @if($selectedVehicleInfo['plate_number_image'])
                            <img src="{{url('storage/'.$selectedVehicleInfo['plate_number_image'])}}" class="avatar" wire:click="showNumberplate()">
                            @endif
                            ...
                            <div class="row">
                                <div class="col-md-12 ps-0 my-auto">
                                        <button type="button" class="btn bg-gradient-primary btn-tooltip btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Customer/Discount/Vehicle" data-container="body" data-animation="true" wire:click="editCustomer()">Edit</button>
                                        <button type="button" class="btn bg-gradient-primary btn-tooltip btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Add Customer/Discount/Vehicle" data-container="body" data-animation="true" wire:click="addNewVehicle()">New</button>
                    ...
                    <div class="col-md-12 mt-3 ps-0 my-auto">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="card">
                                    <div class="card-body p-3">
                                        <div class="row">
                                            @foreach($listCustomerDiscontGroups as $listCustDiscGrp)
                                    ...
                                    <div class="row mb-0">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input style="padding:0.5rem 0.3rem !important;" type="text" id="editPlateCode" class="form-control @error('edit_plate_code') btn-outline-danger @enderror" wire:model="edit_plate_code" name="edit_plate_code" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" minlength="1" maxlength="2" placeholder="Code">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
