<main class="main-content">
  <div class="container-fluid py-4">
    ...
    <div class="row">
      ...
      <div class="col-xl-2 col-md-3 col-sm-3 mb-xl-2 mb-2 jobscount qualitycheck">
          <div class="card bg-gradient-warning shadow text-white">
              <div class="card-body p-3 cursor-pointer" wire:click="filterJobListPage('qualitycheck')">
                  <div class="row">
                      <div class="col-12">
                          <div class="numbers">
                              <p class="text-sm mb-0 text-capitalize font-weight-bold">Quality Check</p>
                              <hr class="m-0">
                              <h5 class="font-weight-bolder mb-0 text-white">{{$getCountSalesJob->qualitycheck}}<span class="text-success text-sm font-weight-bolder"></span></h5>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div class="card bg-gradient-info shadow text-white">
              <div class="card-body p-3 cursor-pointer" wire:click="filterJobListPage('ready_to_deliver')">
                  <div class="row">
                      <div class="col-12">
                          <div class="numbers">
                              <p class="text-sm mb-0 text-capitalize font-weight-bold">Ready For Delivery</p>
                              <hr class="m-0">
