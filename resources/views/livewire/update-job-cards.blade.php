    ...
    <div class="container-fluid py-2">
        ...
        <div class="card px-3 my-2" >
            <div class="card-body p-0">
                                ...
                                <div class="card card-profile card-plain">
                                    <div class="card-body text-left p-0">
                                        ...
                                        <div>
                                            ...
                                            <button type="button" class="btn bg-gradient-info btn-tooltip btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Apply Discount Group" data-container="body" data-animation="true" wire:click="clickDiscountGroup()">Add Discount Group</button>
                ...
                @if($showServiceGroup)
                    @include('livewire.service-groups')
                @endif
                @if($showCheckList)
                    <div class="row mt-3">
                                ...
                                <div class="card-body text-left pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-end" id="img1" src="@if($vImageR1) {{$vImageR1->temporaryUrl()}} @elseif($vImageR1T) {{url('public/storage/'.$vImageR1T)}} @else {{asset('img/checklist/car1.png')}} @endif" style="cursor:pointer"  />
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-start" id="img2" src="@if ($vImageR2) {{ $vImageR2->temporaryUrl() }} @elseif($vImageR2T) {{url('public/storage/'.$vImageR2T)}} @else {{asset('img/checklist/car2.png')}} @endif" style="cursor:pointer"  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-end" id="img3" src="@if ($vImageF) {{ $vImageF->temporaryUrl() }} @elseif($vImageFT)  {{url('public/storage/'.$vImageFT)}}  @else {{asset('img/checklist/car3.jpg')}} @endif" style="cursor:pointer"  />
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-start" id="img4" src="@if ($vImageB) {{ $vImageB->temporaryUrl() }} @elseif($vImageBT)  {{url('public/storage/'.$vImageBT)}}  @else {{asset('img/checklist/car4.jpg')}} @endif" style="cursor:pointer"  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-end" id="img5" src="@if ($vImageL1) {{ $vImageL1->temporaryUrl() }} @elseif($vImageL1T)  {{url('public/storage/'.$vImageL1T)}}  @else {{asset('img/checklist/car5.png')}} @endif" style="cursor:pointer"  />
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <img class="w-75 float-start" id="img6" src="@if ($vImageL2) {{ $vImageL2->temporaryUrl() }} @elseif($vImageL2T)  {{url('public/storage/'.$vImageL2T)}}  @else {{asset('img/checklist/car6.png')}} @endif" style="cursor:pointer"   />
